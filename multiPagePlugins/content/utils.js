...
if (globalThis.__MULTIPAGE_UTILS_MESSAGE_LISTENER) {
  chrome.runtime.onMessage.removeListener(globalThis.__MULTIPAGE_UTILS_MESSAGE_LISTENER);
}

globalThis.__MULTIPAGE_UTILS_MESSAGE_LISTENER = (message, sender, sendResponse) => {
...
chrome.runtime.onMessage.addListener(globalThis.__MULTIPAGE_UTILS_MESSAGE_LISTENER);
